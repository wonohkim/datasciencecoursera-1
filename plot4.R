...
plot(file$times,file$Global_active_power,xlab="",ylab="Global Active Power",type="l")

plot(file$times,file$Voltage,xlab="datetime",ylab="Voltage",type="l")

plot(file$times,file$Sub_metering_1,type="l",xlab="",ylab="Energy sub metering")
points(file$times,file$Sub_metering_2,type="l",col="red")
points(file$times,file$Sub_metering_3,type="l",col="blue")
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"),lty=c(1,1,1),lwd=c(1,1,1),bty="n")

plot(file$times,file$Global_reactive_power,xlab="datetime",ylab="Global_reactive_power",type="l")
